...
fetch server/connections.mjs "$DL_APP/bin/connections.mjs"
mkdir -p "$DL_APP/bin/connectors"
fetch server/connectors/engine.mjs             "$DL_APP/bin/connectors/engine.mjs"
fetch server/connectors/registry.mjs           "$DL_APP/bin/connectors/registry.mjs"
fetch server/connectors/registry-generated.mjs "$DL_APP/bin/connectors/registry-generated.mjs"
